  ...
  return (
    <div className="flex flex-col min-h-screen bg-white p-6">
      ...
      <div className="mt-10 mb-12">
        <div className="w-12 h-12 bg-[#1eb2a6] rounded-xl mb-6 flex items-center justify-center text-white font-bold text-2xl italic shadow-lg">A</div>
        <h1 className="text-3xl font-bold text-gray-800 leading-tight">
          Bienvenido a <br />
          <span className="text-[#1eb2a6]">AulaVerde!</span>
        </h1>
        <p className="text-gray-400 mt-4 text-sm max-w-[220px]">Gestiona los residuos de tu colegio de forma sostenible.</p>
      </div>
